namespace Useful_Tags_Lite
{
    ...
    public class DangerRibbonConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def1 = BuildingTemplates.CreateBuildingDef("DangerRibbon", 1, 1, "tag_dangerribbon_kanim", 30, 30f, singleArray1, textArray1, 1600f, BuildLocationRule.Anywhere, nONE, TUNING.NOISE_POLLUTION.NONE, 0.2f);
